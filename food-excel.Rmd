...
library(janitor)
fave_food_cleaned_names <- fav_food %>% 
  janitor::clean_names()
fav_food_cleaned_names <- read_excel("C:/Users/rgood28/documents/Data Sci Labs/ae-06-nobels-sales-dataimport/favourite-food.xlsx",
                       na = c("NA", "99999", "N/A"))
